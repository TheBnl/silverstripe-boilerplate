            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    <td style="font-family: sans-serif; font-size: 16px; line-height: 24px; color: $Theme.White; padding: 0 20px 20px; text-align: left;">
                        <img src="{$AbsoluteBaseURL}{$Theme.MailLogo}" width="$Theme.MailLogoWidth" alt="$SiteConfig.Title" border="0" style="max-width: $Theme.MailLogoWidth; height: auto; font-family: sans-serif; font-size: 16px; line-height: 15px; color: $Theme.White; display: block; border: 0px;">
                    </td>
                </tr>
            </table>
        </th>
